  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="LNPR Capital is a leading financial services company offering expert investment advice and portfolio management to help you achieve your financial goals."
        ></meta>
        <meta
          name="keywords"
          content="LNPR Capital, Financial Services, Investment Advice, Portfolio Management, Financial Goals"
        ></meta>
        <meta name="author" content="LNPR Capital"></meta>
        <title>LNPR Capital</title>
            ...
            <div className="hero-section grid grid-cols-1 md:grid-cols-2 gap-4 px-6 py-10 max-w-7xl mx-auto">
              <div className="hero-content flex flex-col justify-center items-center">
                ...
                <p className="text-gray-600 text-base md:text-lg text-center">
                  We are a independent equity research firm. We offer equity
