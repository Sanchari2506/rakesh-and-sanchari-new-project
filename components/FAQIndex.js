...
export default function FAQIndex({ limit }) {
  const faqs = [
    {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="btn-wrap flex justify-center mt-6 py-3 px-8 rounded-2xl bg-[#0a3758] w-fit mx-auto">
        <a className="text-white underline text-base md:text-lg" href="/faqs">View All</a>
      </div>
    </div>
  );
}
